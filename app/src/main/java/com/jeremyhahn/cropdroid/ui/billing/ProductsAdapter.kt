package com.jeremyhahn.cropdroid.ui.billing
...
class ProductsAdapter(private val context: Context, private val list: List<SkuDetails>, private val onProductClicked: (SkuDetails) -> Unit) : RecyclerView.Adapter<ProductsAdapter.ViewHolder>() {
