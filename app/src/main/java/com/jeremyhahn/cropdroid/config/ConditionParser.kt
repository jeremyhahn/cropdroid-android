    ...
    companion object {
        ...
        fun parse(jsonConditions : JSONArray) : ArrayList<Condition> {
            ...
            for (i in 0..jsonConditions.length() - 1) {
                ...
                val workflowId = jsonCondition.getLong("workflowId")
                ...
                conditions.add(Condition(id, controllerType, metricId, metricName, workflowId, channelId, comparator, threshold, text))
            }
            return conditions
        }
    }
